...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","c:\\gitbuild\\sample");
    parameters.put("artifactId","sample");
    parameters.put("outputDirectory","c:\\gitbuild\\sample\\target\\classes");
    parameters.put("testOutputDirectory","c:\\gitbuild\\sample\\target\\test-classes");
